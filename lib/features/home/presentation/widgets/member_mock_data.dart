...
// ── Mock fallback (se usa si SharedPreferences está vacío) ───────────────────

final kFamilyMembersFallback = <FamilyMember>[
  FamilyMember(
    id: 'mock-1',
    name: 'Laura',
    avatarColor: AppColors.categoryGardenFg,
    score: 12,
    totalTasks: 14,
    level: 5,
    streakDays: 7,
  ...
  FamilyMember(
    id: 'mock-2',
    name: 'Carlos',
    avatarColor: AppColors.categoryCleaningFg,
    score: 9,
    totalTasks: 14,
    level: 4,
    streakDays: 3,
  ...
  FamilyMember(
    id: 'mock-3',
    name: 'Sofía',
    avatarColor: AppColors.categoryCookingFg,
    score: 6,
    totalTasks: 14,
    level: 3,
    streakDays: 5,
  ...
  FamilyMember(
    id: 'mock-4',
    name: 'Miguel',
    avatarColor: AppColors.categoryLaundryFg,
    score: 4,
    totalTasks: 14,
    level: 2,
    streakDays: 1,
