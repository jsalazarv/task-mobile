...
class _TaskCardState extends State<TaskCard> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: widget.onTap,
      child: _CardContent(task: widget.task, onToggle: _handleToggle),
    );
  }
}
...
class _CardContent extends StatelessWidget {
  const _CardContent({required this.task, required this.onToggle});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _Checkbox(completed: task.completed, onTap: onToggle),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                _CategoryLabel(
                  category: TaskService.instance.resolveCategory(task),
                ),
...
class _Checkbox extends StatelessWidget {
  const _Checkbox({required this.completed, required this.onTap, super.key});
...
class _CategoryLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Icon(category.icon, size: 13, color: category.foreground),
